...
namespace BCI_Project.Migrations
{
    ...
    [Migration("20240626173531_updatedseed")]
            ...
            modelBuilder.Entity("BCI_Project.Models.Attributes", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("55a5cf4c-2c6a-4616-9f67-ff2fc3d5aca8"),
                            AttributeName = "Age",
                            AttributeType = "int",
                            IsDeleted = false
                        },
                        new
                        {
                            Id = new Guid("b30c6114-c44a-4981-b02a-7b447bec69cb"),
                        ...
                        new
                        {
                            Id = new Guid("75574016-d614-4c24-9948-4f6901f5e9ab"),
            ...
            modelBuilder.Entity("BCI_Project.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "3f2ff8b1-6ac1-48a9-bae8-f01a4063e2cc",
                            ConcurrencyStamp = "1",
                            Name = "Admin",
                        ...
                        new
                        {
                            Id = "d4fadb34-0a98-49e6-82ad-bdbc29a324d2",
                            ConcurrencyStamp = "2",
                            Name = "Patient",
                        ...
                        new
                        {
                            Id = "53a5b440-d100-408a-8be1-f600a930c9dc",
                            ConcurrencyStamp = "3",
                            Name = "Doctor",
            ...
            modelBuilder.Entity("BCI_Project.Models.RoleAttributes", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3fc3d9b5-b3ec-4682-b135-9fccbaee7997"),
                            AttributeId = new Guid("55a5cf4c-2c6a-4616-9f67-ff2fc3d5aca8"),
                            IsDeleted = false,
                            RoleId = "d4fadb34-0a98-49e6-82ad-bdbc29a324d2"
                        },
                        new
                        {
                            Id = new Guid("3444a8c0-aaa1-47c6-9597-75d0dca70ddd"),
                            AttributeId = new Guid("b30c6114-c44a-4981-b02a-7b447bec69cb"),
                            IsDeleted = false,
                            RoleId = "d4fadb34-0a98-49e6-82ad-bdbc29a324d2"
                        },
                        new
                        {
                            Id = new Guid("1a6cd588-4507-4de3-8d84-c083c8e87be8"),
                            AttributeId = new Guid("75574016-d614-4c24-9948-4f6901f5e9ab"),
                            IsDeleted = false,
                            RoleId = "d4fadb34-0a98-49e6-82ad-bdbc29a324d2"
                        });
                });
