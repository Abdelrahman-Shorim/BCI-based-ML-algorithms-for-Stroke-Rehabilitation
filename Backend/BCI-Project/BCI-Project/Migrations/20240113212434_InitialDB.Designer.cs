...
namespace BCI_Project.Migrations
{
    ...
    [Migration("20240113212434_InitialDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BCI_Project.Models.GameLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BCI_Project.Models.GameLog", b =>
                {
                    b.HasOne("BCI_Project.Models.Levels", "Level")
                        .WithMany("GameLogLevels")
                        .HasForeignKey("LevelId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("BCI_Project.Models.User", "Patient")
                        .WithMany("GameLogPatients")
                        .HasForeignKey("PatientId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("BCI_Project.Models.GameMovements", b =>
                {
                    b.HasOne("BCI_Project.Models.GameLog", "GameLog")
                        .WithMany("GameMovementsGameLogs")
            ...
            modelBuilder.Entity("BCI_Project.Models.GameLog", b =>
                {
                    b.Navigation("GameMovementsGameLogs");
                });

            modelBuilder.Entity("BCI_Project.Models.Levels", b =>
                {
                    b.Navigation("GameLogLevels");
                });
